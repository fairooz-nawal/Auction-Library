...
const Favourite = ({markedBook,handleDeleteBookMark}) => {
    let totalAmount = 0;
    ...
    return (
        <div className='col-span-2 rounded-3xl text-center'>
            <div className=" bg-white space-y-5 p-5 rounded-2xl">
                ...
                {markedBook.length > 0 ? <BookmarkCollection markedBook = {markedBook} handleDeleteBookMark={handleDeleteBookMark}></BookmarkCollection> : <Empty></Empty>}
                <hr className='text-gray-300' />
